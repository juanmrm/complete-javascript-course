...
for (const [key, value] of question.entries()) { // Destructuring example
...
var Athlete5 = function(name, yearOfBirth, job, olympicGames, medals) {
  Person5.call(this, name, yearOfBirth, job); // Call superclass constructor 
  this.olympicGames = olympicGames;
  this.medals = medals;
}
// Asi es como hacemos que el prototype chain sea el que queremos. 
// Person5 es la clase padre de Athlete5 que es la subclase.
...
const johnAthlete6 = new Athlete6('John', 1990, 'teacher', 3, 10);
